 ...
 *    \\fenphen\phartke\slink\group\bluetooth\nexys2\sdk_test_11_1\
 */
...
int main (void) {
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for LED_7SEGMENT...\r\n");

      status = GpioOutputExample(XPAR_LED_7SEGMENT_DEVICE_ID,12);
...

   {
      ...
      print("\r\nRunning GpioInputExample() for Switches_8Bit...\r\n");

      Xuint32 DataRead;
      
      status = GpioInputExample(XPAR_SWITCHES_8BIT_DEVICE_ID, &DataRead);
   ...
   /*
    * Peripheral SelfTest will not be run for RS232_PORT
